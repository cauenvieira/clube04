(() => {
    ...
    // 1. LÓGICA DE VALIDAÇÃO DE PÁGINA
    // Se não estiver na página correta, avisa, redireciona e para a execução.
    ...
    // A partir daqui, o código só executa se estivermos na página correta.

    // =========================================================================
    // LÓGICA DE EXECUÇÃO (O "CÉREBRO" DO SCRIPT)
    // =========================================================================

    // A função que cria o painel e toda a mágica visual.
    function rodarGerador() {
        const painelExistente = document.getElementById('dr-painel');
        if (painelExistente) {
            painelExistente.style.display = 'block'; // Apenas reexibe se já existir
            return;
        }
    ...
    // =========================================================================
    // BOTÃO FLUTUANTE (O "GATILHO" DO SCRIPT)
    // =========================================================================

    // 2. Cria o botão flutuante APENAS se estiver na página correta.
